...
public class DetailMessageAdapter extends RecyclerView.Adapter<DetailMessageAdapter.DetailMessageViewHolder>{
    ...
    private boolean isMe(int position) {
        Message message = mMessages.get(position);
        return message.getSender().getObjectId() != null && message.getSender().getObjectId().equals(mCurrUserId);
    }
