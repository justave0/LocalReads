...
public class LoginActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btLoginCreateAccount.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
  ...
  private void authenticateBackend(JSONObject jsonObject, String idTokenString)
...
//    ParseUser user = (ParseUser) userQuery.getFirst();
  ...
  private void showGoogleSignUpDialog(HashMap<String, String> jsonData) {
    ...
    GoogleSignUpDialogFragment googleSignUpDialogFragment =
        GoogleSignUpDialogFragment.newInstance(jsonData);
