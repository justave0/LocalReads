...
public class GoogleSignUpDialogFragment extends DialogFragment {
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    btGoogleMoreInfo.setOnClickListener(
    ...
    btGoogleSignUpContinue.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            ...
            String tag =
                (String)
                    ((Button) view.findViewById(bgGoogleChoice.getCheckedButtonId())).getText();
  ...
  private void inflateInfoMenu(View v) {
    new MaterialAlertDialogBuilder(getContext())
        .setTitle("User Type")
        .setMessage(
            "Local Reads allows users to create their account as either a reader or "
